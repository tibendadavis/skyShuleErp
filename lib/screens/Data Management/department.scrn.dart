...
import 'package:skyconnect_starter/screens/Data%20Management/addDepartment.scrn.dart';
          ...
          children: [
            ...
            SizedBox(
                width: Responsive.isDesktop(context)
                    ? 410
                    : MediaQuery.of(context).size.width,
                child: tile2(tileHeading: "Departments", tileData: "7")),
          ],
        ),
        searchBar(title: "Search for Department"),
                ...
                child: SingleChildScrollView(
                  ...
                  child: DataTable(
                      ...
                      columns: [
                        ...
                        DataColumn(
                            label: SizedBox(
                          width: Responsive.isDesktop(context) ? 270 : 150,
                          child: HeadingText(
                            size: 14,
