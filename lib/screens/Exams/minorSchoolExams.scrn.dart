...
import 'package:skyconnect_starter/screens/addMinorSchoolExam.scrn.dart';
                ...
                child: SizedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Heading6(
                            value: "Total Minor School Exams",
                            color: Colors.white),
                      )
                    ],
                  ),
                  ...
                  Expanded(
                      ...
                      child: TextFormField(
                          decoration: const InputDecoration(
                              ...
                              hintText: " Search for Minor School Exams",
                      ...
                      child: Container(
                        ...
                        child: DropdownButton(
                          items: const [
                            ...
                            DropdownMenuItem(
                                child: Heading6(
                                    value: "Assignmnets", color: Colors.white),
                                value: "Assignments"),
                            DropdownMenuItem(
                                child: Heading6(
                                    value: "Exercises", color: Colors.white),
                                value: "Exercises"),
                            DropdownMenuItem(
                                child: Heading6(
                                    value: "WEEKLY TEST", color: Colors.white),
                                value: "WEEKLY TEST"),
                            DropdownMenuItem(
                                child: Heading6(
                                    value: "MONTHLY TEST", color: Colors.white),
                                value: "MONTHLY")
                          ],
                          hint: Heading6(
                            value: "Exam Group",
                  ...
                  Container(
                      child: TextFormField(
                          decoration: const InputDecoration(
                              ...
                              //         color: Palette().borderColor, width: 3.0)),
                              border: InputBorder.none,
                              hintText: " Search for Minor School Exam",
                              hintStyle: TextStyle(fontSize: 20)))),
                  SizedBox(
