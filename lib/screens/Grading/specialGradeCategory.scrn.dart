...
import 'package:skyconnect_starter/screens/addBookCategory.scrn.dart';
import 'package:skyconnect_starter/screens/addSpecialGradeCategory.scrn.dart';
...
class specialGradeCategory extends StatefulWidget {
  const specialGradeCategory({super.key});

  @override
  State<specialGradeCategory> createState() => _specialGradeCategoryState();
}

class _specialGradeCategoryState extends State<specialGradeCategory> {
  bool _menu = false;
                    ...
                    children: [
                      ...
                      ElevatedButton(
                          onPressed: () {
                            showDialog(
                                context: context,
                                builder: (_) => addSpecialGradeCategory());
                          },
                          ...
                          child: Heading5(
                            value: "Add Special Grade Category",
                            color: Colors.black,
                          ))
                    ],
                  ),
                ...
                child: SizedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Heading6(
                            value: "Total Categories", color: Colors.white),
                      )
                    ],
                  ),
                ),
                  ...
                  child: DataTable(
                      ...
                      columns: [
                        ...
                        DataColumn(
                          ...
                          child: HeadingText(
                            size: 14,
                            value: "Special Grade Category Code",
                            fontWeight: FontWeight.w700,
                          ),
                        )),
                        DataColumn(
