...
class addRequestOrder extends StatefulWidget {
  const addRequestOrder({super.key});

  @override
  State<addRequestOrder> createState() => _addRequestOrderState();
}

class _addRequestOrderState extends State<addRequestOrder>
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const Heading3(
                          value: "Request Order Information",
                      ...
                      children: [
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              inputTextField(
                                title: "Request Order No.",
                                hintText: "Request Order No.",
                              ),
                              SizedBox(
                              ...
                              inputOptions(title: "Store Name", opt1: ""),
                              SizedBox(
                                height: Responsive.isDesktop(context) ? 10 : 15,
                              ),
                              inputDate(
                                  heading: "Request Order Date",
                                  subheading: "Date"),
                              SizedBox(
                                height: Responsive.isDesktop(context) ? 10 : 15,
                              ),
