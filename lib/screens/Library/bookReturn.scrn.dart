...
import 'package:skyconnect_starter/screens/Library/addBookReturn.scrn.dart';
          ...
          children: [
            SizedBox(
                ...
                child: tile3(
                  icon: Icons.book,
                  link: addBookReturn(),
                  linkTitle: "Add Book Return",
                )),
            SizedBox(
              width: Responsive.isDesktop(context)
                  ? 410
                  : MediaQuery.of(context).size.width,
              child: tile2(tileHeading: "Total Books Returned", tileData: "7"),
            ),
          ],
        ),
        searchBar(
          title: "Search for Book Returned",
          opt1: searchInputOptions(title: "Book Title", opt1: ""),
          opt2: searchInputOptions(title: "Return Type", opt1: ""),
        ),
                ...
                child: SingleChildScrollView(
                  ...
                  child: DataTable(
                      ...
                      columns: [
                        ...
                        DataColumn(
                            label: SizedBox(
                          width: Responsive.isDesktop(context) ? 230 : 130,
                          child: HeadingText(
                            size: 14,
                            value: "Return Date/Book Due Date",
                            fontWeight: FontWeight.w700,
                          ),
                        )),
                        DataColumn(
