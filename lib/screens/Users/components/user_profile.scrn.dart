            ...
            Container(
              ...
              padding: EdgeInsets.only(
                ...
                left: Responsive.isDesktop(context)
                    ...
                    : Insets().appPadding,
                right: Insets().appGap,
                bottom: Responsive.isDesktop(context) ? Insets().appPadding : 0,
              ),
              child: HeadingText(
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      mainAxisAlignment:
                                          MainAxisAlignment.spaceBetween,
                                      children: [
                                        HeadingText(size: 14, value: "Class: "),
                                        SizedBox(
                                          width: 2,
                                        ),
                                        HeadingText(
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                          ...
                          children: [
                            ElevatedButton(
                                ...
                                child: Heading6(
                                  value: "Students Info",
                                  color:
                                      !stdntsInfo ? Colors.black : Colors.white,
                                )),
                            SizedBox(
                              width: 15,
                            ),
                    ...
                    Visibility(visible: stdntsInfo, child: (studentsInfo())),
                    Visibility(visible: prntsInfo, child: (parentsInfo())),
                    Visibility(visible: paymntReport, child: (paymentReport())),
