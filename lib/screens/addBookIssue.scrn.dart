...
class addBookIssue extends StatefulWidget {
  const addBookIssue({super.key});

  @override
  State<addBookIssue> createState() => _addBookIssueState();
}

class _addBookIssueState extends State<addBookIssue>
                                          ...
                                          onTap: () async {
                                            ...
                                            final formattedDate =
                                                DateFormat('yyyy-MM-dd')
                                                    .format(date!);
                                            setState(() {
                                              _bookDueDate.text = formattedDate;
                                            });
                                          },
                                          textAlignVertical:
                                              TextAlignVertical.center,
