...
class addFeePayment extends StatefulWidget {
  const addFeePayment({super.key});

  @override
  State<addFeePayment> createState() => _addFeePaymentState();
}

class _addFeePaymentState extends State<addFeePayment>
    with SingleTickerProviderStateMixin {
  bool _menu = false;
  late AnimationController controller;
  late Animation<double> scaleAnimation;
  TextEditingController _dateOfPayment = TextEditingController();
