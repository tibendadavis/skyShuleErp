...
class addPayroll extends StatefulWidget {
  const addPayroll({super.key});

  @override
  State<addPayroll> createState() => _addPayrollState();
}

class _addPayrollState extends State<addPayroll>
    with SingleTickerProviderStateMixin {
  bool _menu = false;
  late AnimationController controller;
  late Animation<double> scaleAnimation;
  TextEditingController _dateOfPayroll = TextEditingController();
