...
class addSupplierType extends StatefulWidget {
  const addSupplierType({super.key});

  @override
  State<addSupplierType> createState() => _addSupplierTypeState();
}
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const Heading3(
                          value: "Supplier Type Information",
                      ...
                      children: [
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              inputTextField(
                                  title: "Supplier Type Name",
                                  hintText: "Supplier Type Name"),
                              SizedBox(
                                height: Responsive.isDesktop(context) ? 10 : 15,
                              ),
                              inputTextField(
                                  title: "Supplier Type Code",
                                  hintText: "Supplier Type Code"),
                              SizedBox(
                                height: Responsive.isDesktop(context) ? 10 : 15,
                              ),
                              Flex(
