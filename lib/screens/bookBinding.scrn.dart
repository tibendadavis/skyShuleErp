...
import 'package:skyconnect_starter/screens/addBookBinding.scrn.dart';
...
class bookBinding extends StatefulWidget {
  const bookBinding({super.key});

  @override
  State<bookBinding> createState() => _bookBindingState();
}

class _bookBindingState extends State<bookBinding> {
  bool _menu = false;
                ...
                child: SizedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Heading6(
                            value: "Total Book Bindings", color: Colors.white),
                      )
                    ],
                  ),
                ),
                  ...
                  Expanded(
                      ...
                      child: TextFormField(
                          decoration: const InputDecoration(
                              ...
                              hintText: " Search for Book Binding",
                ...
                child: SingleChildScrollView(
                  ...
                  child: DataTable(
                      ...
                      columns: [
                        ...
                        DataColumn(
                            label: SizedBox(
                          width: Responsive.isDesktop(context) ? 650 : 150,
                          child: HeadingText(
                            size: 14,
                            value: "Title",
                            fontWeight: FontWeight.w700,
