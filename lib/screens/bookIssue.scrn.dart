                          ...
                          Expanded(
                              ...
                              child: TextFormField(
                                  decoration: const InputDecoration(
                                      ...
                                      hintText: " Search for Book Issue",
                          ...
                          child: DataTable(
                              ...
                              columns: [
                                ...
                                DataColumn(
                                    label: SizedBox(
                                  width:
                                      Responsive.isDesktop(context) ? 110 : 100,
                                  child: HeadingText(
                                    size: 14,
                                    value: "User",
                                    fontWeight: FontWeight.w700,
                                ...
                                DataColumn(
                                    label: SizedBox(
                                  width:
                                      Responsive.isDesktop(context) ? 140 : 100,
                                  child: HeadingText(
                                    size: 14,
                                ...
                                DataColumn(
                                    label: SizedBox(
                                  width:
                                      Responsive.isDesktop(context) ? 200 : 130,
                                  child: HeadingText(
                                    size: 14,
