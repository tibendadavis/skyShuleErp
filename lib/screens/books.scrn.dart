                  ...
                  child: Row(
                    children: [
                      ...
                      ElevatedButton(
                          onPressed: () {
                            showDialog(
                                context: context, builder: (_) => addBooks());
                          },
                ...
                child: SizedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Expanded(
                        child:
                            Heading6(value: "Total Books", color: Colors.white),
                      )
                    ],
                  ),
                ),
                      ...
                      child: Container(
                        ...
                        child: DropdownButton(
                          items: const [
                            ...
                            DropdownMenuItem(
                                child: Heading6(
                                    value: "Repairable", color: Colors.white),
                                value: "Repairable"),
                            DropdownMenuItem(
                                child: Heading6(
                            ...
                            DropdownMenuItem(
                                child: Heading6(
                                    value: "Subjects", color: Colors.white),
                                value: "Subjects")
                          ],
                          hint: Heading6(
                            value: "Category",
                ...
                child: SingleChildScrollView(
                  ...
                  child: DataTable(
                      ...
                      columns: [
                        ...
                        DataColumn(
                            label: SizedBox(
                          width: Responsive.isDesktop(context) ? null : 130,
                          child: HeadingText(
                            size: 14,
                            value: "Book Quantity",
                            fontWeight: FontWeight.w700,
