                ...
                child: SizedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Expanded(
                        child:
                            Heading6(value: "Total Files", color: Colors.white),
                      )
                    ],
                  ),
                ),
                    ...
                    child: Container(
                      ...
                      child: DropdownButton(
                        items: const [
                          ...
                          DropdownMenuItem(
                              child: Heading6(
                                  value: "Category Two", color: Colors.white),
                              value: "Category Two"),
                          DropdownMenuItem(
                              child: Heading6(
                                  value: "Category Three", color: Colors.white),
                    ...
                    child: SizedBox(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Container(
                              width: 100,
                              margin: EdgeInsets.only(left: Insets().appGap),
                              padding: EdgeInsets.only(
                                left: Insets().appGap,
                              ),
                              decoration: BoxDecoration(
