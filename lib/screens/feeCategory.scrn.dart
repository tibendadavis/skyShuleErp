...
class feeCategory extends StatefulWidget {
  const feeCategory({super.key});

  @override
  State<feeCategory> createState() => _feeCategoryState();
}

class _feeCategoryState extends State<feeCategory> {
  bool _menu = false;
                          ...
                          Expanded(
                              ...
                              child: TextFormField(
                                  decoration: const InputDecoration(
                                      ...
                                      hintText: " Search for Fee Category",
                          ...
                          child: DataTable(
                              ...
                              columns: [
                                ...
                                DataColumn(
                                    label: SizedBox(
                                  width:
                                      Responsive.isDesktop(context) ? 220 : 100,
                                  child: HeadingText(
                                    size: 14,
                                    value: "Action",
                                    fontWeight: FontWeight.w700,
