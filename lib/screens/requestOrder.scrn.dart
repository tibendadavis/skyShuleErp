...
import 'package:skyconnect_starter/screens/addRequestOrder.scrn.dart';
                ...
                child: SizedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Heading6(
                            value: "Total Requests", color: Colors.white),
                      )
                    ],
                  ),
                ),
                  ...
                  Expanded(
                      ...
                      child: TextFormField(
                          decoration: const InputDecoration(
                              ...
                              hintText: " Search for Request Order",
                      ...
                      child: Container(
                        ...
                        child: DropdownButton(
                          items: const [
                            ...
                            DropdownMenuItem(
                                child: Heading6(
                                    value: "Pending", color: Colors.white),
                                value: "Pending"),
                            DropdownMenuItem(
                                child: Heading6(
                                    value: "Rejected", color: Colors.white),
                                value: "Rejected")
                          ],
                          hint: Heading6(
                            value: "Status",
                  ...
                  Container(
                    ...
                    child: DropdownButton(
                      items: const [
                        ...
                        DropdownMenuItem(
                            child:
                                Heading6(value: "Pending", color: Colors.white),
                            value: "Pending"),
                        DropdownMenuItem(
                            child: Heading6(
                                value: "Rejected", color: Colors.white),
