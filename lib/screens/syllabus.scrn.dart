...
import 'package:skyconnect_starter/screens/addSyllabus.scrn.dart';
                          ...
                          child: DataTable(
                              ...
                              columns: [
                                ...
                                DataColumn(
                                    label: SizedBox(
                                  width:
                                      Responsive.isDesktop(context) ? 140 : 50,
                                  child: HeadingText(
                                    size: 14,
                                ...
                                DataColumn(
                                    label: SizedBox(
                                  width:
                                      Responsive.isDesktop(context) ? 140 : 65,
                                  child: HeadingText(
                                    size: 14,
                                    value: "Department",
                                    fontWeight: FontWeight.w700,
                                ...
                                DataColumn(
                                    label: SizedBox(
                                  width:
                                      Responsive.isDesktop(context) ? 80 : 80,
                                  child: HeadingText(
                                    size: 14,
                                    value: "Term",
                                    fontWeight: FontWeight.w700,
